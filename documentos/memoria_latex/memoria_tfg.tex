...
% [IMAGEN OPCIONAL - PIPELINE]
% Recomendación fuerte: añadir un diagrama de pipeline específico de este TFG (entrada radiografía -> preprocesado/recorte -> aumento -> modelo -> métricas + Grad-CAM).
% Colócalo al final de la sección para cerrar con una visión global.
% \begin{figure}[ht]
%   \centering
%   \includegraphics[width=0.9\textwidth]{pipeline_tfg.png}
%   \caption{Esquema de pipeline seguido en el TFG: desde la radiografía de entrada hasta la evaluación y la interpretabilidad con Grad-CAM.}
%   \label{fig:pipeline_tfg}
% \end{figure}
...
% [FIGURA A RECREAR]
% Recomendación: reemplazar la imagen genérica por un esquema propio vectorial (capas totalmente conectadas con activaciones)
% para evitar problemas de licencia y mejorar legibilidad en impresión B/N.
\begin{figure}[htbp]
    \centering
...
% [FIGURA CNN]
% Si ya incluyes una figura CNN en otro capítulo, evita duplicar; en ese caso, referencia cruzada.
...
\begin{figure}[ht] \centering \includegraphics[width=1\textwidth]{vit.png} 
...
tareas de diagnóstico automatizado, pronóstico de la enfermedad y evaluación de biomarcadores, ámbitos que requieren una descripción exhaustiva de las características 
